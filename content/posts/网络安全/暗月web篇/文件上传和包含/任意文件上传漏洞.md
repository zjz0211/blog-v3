...
permalink: /arbitrary-file-upload
---
...
![](/images/20260407160125.webp)

直接上传文件 网页会返回路径 访问 url 即可 getshell、
![](/images/20260407160259.webp)
上传的文件可以改成其他恶意脚本或者后门，即可获得 webshell。
![](/images/20260407160343.webp)
...
![](/images/20260407164206.webp)

# 7.空格上传绕过
### 1.代码分析
在上传模块里，采用黑名单上传，如果没有对空格进行去掉可能被绕过。
![](/images/20260407164540.webp)
检测 submit 后 上传目录存在时，进入黑名单判断。如果文件后缀名在黑名单里。不允许上传，但是文件后缀名，没有过滤空格，可以添加空格绕过。
### 2.攻击方法
抓包上传，在后缀名后添加空格
![](/images/20260407164753.webp)

# 8.利用windows系统特征绕过
### 1.代码分析
![](/images/20260407164851.webp)
同样是黑名单禁止上传，但是可以上传.php.这种文件后缀。
### 2.攻击方法
抓包修改在后缀名后加上 . 即可绕过。
![](/images/20260407164936.webp)
