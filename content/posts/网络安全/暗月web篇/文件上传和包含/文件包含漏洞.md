...
# 3.文件包含漏洞代码分析
![](/images/20260407184153.webp)$_GET['filename'] 接收客户端传的参数，其中没有任何过滤 带入到 include 函数中，include 包含这个文件，引入到当前文件中，因此会造成文件包含漏洞。
# 4.文件包含漏洞的利用方法
文件包含漏洞，需要引入上传的文件到网站目录，或是服务器内部的文件，而且是权限是可读，才能引入进来，或远程包含进来，但是需要条件。

# 5.文件包含/etc/passwd
![](/images/20260407184801.webp)
...
![](/images/20260407185446.webp)
/proc/self/environ 这个文件里保存了系统的一些变量
![](/images/20260407185630.webp)
...
![](/images/20260407193141.webp)
读取文件后再进行 base64 解码
![](/images/20260407193254.webp)
# 13.其他的伪协议
#### phar://、zip://、bzip2://、zlib://
