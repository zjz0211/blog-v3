...
permalink: /kan-xue-web/sql-injection/boolean-blind
description: "布尔盲注是 SQL 注入的一种类型，核心特点是 ==页面不直接显示查询结果或错误信息== ，而是通过返回页面的布尔状态（如“成功/失败”“显示/不显示”）来判断注入语句的执行结果，从而逐步推断数据库中的敏感信息。"
---
