...
<link-card link="https://blog.zhilu.site/previews/example" title="组件样式示例" className="gradient-card,active">
...
<link-banner banner="https://assets.zhilu.cyou/cover3/blog-using-nuxt.jpg" link="https://blog.zhilu.site/2024/blog-using-nuxt" title="博客进化：从 Hexo 到 Nuxt Content">
...
- 借鉴了众多优秀设计，自己的一些设计也为 <tip tip="真的有不少！">
